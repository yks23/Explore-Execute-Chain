...
while [[ $# -gt 0 ]]; do
    case $1 in
        ...
        -h|--help)
            ...
            echo "  -h, --help        显示帮助信息"
            echo "数据集链接:"
            echo "  官方源: https://huggingface.co/datasets/anomyous-author/Explore-Execute-Chain-Datasets"
            echo "  镜像源: https://hf-mirror.com/datasets/anomyous-author/Explore-Execute-Chain-Datasets"
            echo ""
            echo "环境变量:"
