...
class DAPORewardManager(AbstractRewardManager):
    ...
    def __call__(self, data: DataProto, return_dict: bool = False):
        ...
        for i in range(len(data)):
            ...
            special_token_list=["<EXECUTION>", "</EXECUTION>","<EXPLORATION>","</EXPLORATION>","<think>","</think>"]
            prompt_str = decode_with_selected_special_tokens(self.tokenizer, special_token_list, valid_prompt_ids.tolist())
            response_str = decode_with_selected_special_tokens(self.tokenizer, special_token_list, valid_response_ids.tolist())

            # if "</EXPLORATION>" not in response_str and "<EXECUTION>" not in response_str:
                # print(response_str)
