...
if __name__ == "__main__":
    ...
    config = ModelMergerConfig(
        operation="merge",
        backend="fsdp",
        local_dir="/home/fit/alex/Kaisen.Yang/CoT Decomposition/verl/verl/trainer/checkpoints/verl_grpo_dapo/CoT/global_step_80/actor",
        target_dir="/home/fit/alex/Kaisen.Yang/CoT Decomposition/verl/verl/trainer/checkpoints/verl_grpo_dapo/CoT/global_step_80/full.safetensors"
    )
    merger = FSDPModelMerger(config)
    merger.merge_and_save()
